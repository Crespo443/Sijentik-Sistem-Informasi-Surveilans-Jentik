...
export default function SurveyInput() {
  ...
  const handleContainerChange = (index: number, field: 'inspectedCount' | 'positiveCount', value: string) => {
    ...
    // If user clears the input, allow it to be empty string in state
    if (value === '') {
          ...
          <form className="animate-fade-in" onSubmit={handleSubmit}>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Select
                      ...
                      isClearable
                    />
                    {/* Hidden input to preserve HTML5 required validation */}
            ...
            <div className="bg-surface border border-border-subtle shadow-card rounded p-6 mb-5">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-base font-bold font-heading text-text-main">5. PSN 3M Plus</h2>
              </div>
