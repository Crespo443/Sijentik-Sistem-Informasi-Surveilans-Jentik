...
const Dashboard = () => {
  ...
  const regionalData = dashboardQuery.data?.regionalData ?? [];
    ...
    <div className="max-w-350 mx-auto space-y-6">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 animate-fade-in">
        ...
        {(() => {
          ...
          const abjRisk =
            abj < 80 ? "CRITICAL" : abj < 95 ? "WARNING" : "RENDAH";
          const overallRisk =
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  <p className={`text-sm font-bold ${cfg.titleColor}`}>
                    {cfg.title}
                  </p>
                  <span
        ...
        <div className="shrink-0 flex items-center gap-2 z-30 relative min-w-[200px]">
          <Select
            ...
            onChange={(selected: any) =>
              setFilterPeriod(selected?.value || "all")
            }
            styles={{
              ...selectCustomStyles,
              control: (base) => ({
